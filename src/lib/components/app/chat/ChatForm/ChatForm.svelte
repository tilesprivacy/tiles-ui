...
>
	...
	<div
		class="{INPUT_CLASSES} overflow-hidden rounded-lg backdrop-blur-md {disabled
	...
	>
		...
		<div
			class="flex-column relative min-h-12 items-center rounded-lg py-2 pb-2.25 transition-all md:py-3!"
		>
			<ChatFormInput
				bind:this={inputRef}
				bind:value
