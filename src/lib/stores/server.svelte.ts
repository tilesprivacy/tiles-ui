...
class ServerStore {
	...
	loading = $state(false);
	props = $state<ApiServerProps | null>(null);
	...
	get defaultParams(): ApiServerProps['default_generation_settings']['params'] | null {
	...
	private detectRole(props: ApiServerProps): void {
