 ...
 */
export function mockServerProps(props: Partial<ApiServerProps>): void {
	...
	(serverStore as unknown as { props: ApiServerProps }).props = {
		modalities: {
	...
	(serverStore as unknown as { props: ApiServerProps }).props.role = 'ROUTER';
